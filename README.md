...
使用你的ip+端口/full-pack.7z 下载文件后;
Chrome 输入: chrome://flags/#unsafely-treat-insecure-origin-as-secure 并启用此项并添加你的ip+端口即可本地导入;
Edge 输入: edge://flags/#unsafely-treat-insecure-origin-as-secure 并启用此项并添加你的ip+端口即可本地导入
## 当前技术状态
